          ...
          <div class="container-fluid">
            ...
            <div class="mx-5 my-4">
              ...
              <table class="table table-hover my-3" id="dtBasicExample">
                  ...
                  <?php
                  // Displaying bookshelf table data of particular user where progress is 'not in progress'
                      $sql= "select * from bookshelf where username='$user' and progress='Not in progress'";
