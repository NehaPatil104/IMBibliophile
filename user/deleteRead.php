<?php
	//Deleting book with peculiar id from booksread table

	include('../config/constants.php');
	if(isset($_GET['book_id'])){
		//getting the book id of book to delete
		$id = $_GET['book_id'];
		//deleting book from table with particular id and redirecting to read.php 
		$sql = "delete from booksread where id = $id";
